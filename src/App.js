...
import NewDayPortal from './components/portal';
import './App.css';
...
function App() {
  ...
  return (
    <div className="App">
      ...
      {isModalOpen && (
        <NewDayPortal portalId="new-day-modal">
          <Modal onModalClose={() => setIsModalOpen(false)}>
            <ModalHeader>
              <h1 className="modal-heading">About Modal</h1>
            </ModalHeader>
            <ModalBody>
              <p>
                According to the W3C's ARIA Authoring Practices 1.1,
                the modal's role is dialog, and the modal's aria-modal
                attribute is true.
              </p>
              <p>
                <span>
                  The method for setting state for modal close was
                  shared among other components with useContext, this
                  is because the modal component can have as many
                  children as posible.
                </span>
              </p>
              <p>
                Articles on accessible modal components can be found
